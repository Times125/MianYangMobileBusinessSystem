...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        individualLayout = findView(R.id.individual_info);
        ...
        titleText = (TextView) individualLayout.findViewById(R.id.action_bar_title_text);
        back = (ImageView) individualLayout.findViewById(R.id.failed_back);
        titleText.setText(R.string.individualInfo);
        back.setOnClickListener(this);
        titleEditText = (TextView) individualLayout.findViewById(R.id.edit_info_text);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.nick_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_NICKNAME,
                        nickText.getText().toString());
                break;
            case R.id.gender_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_GENDER,
                        String.valueOf(userInfo.getGenderEnum().getValue()));
                break;
            case R.id.birth_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_BIRTH,
                        birthText.getText().toString());
                break;
            case R.id.phone_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_PHONE,
                        phoneText.getText().toString());
                break;
            case R.id.email_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_EMAIL,
                        emailText.getText().toString());
                break;
            case R.id.signature_layout:
                UserProfileEditItemActivity.startActivity(UserProfileSettingActivity.this, UserConstants.KEY_SIGNATURE,
