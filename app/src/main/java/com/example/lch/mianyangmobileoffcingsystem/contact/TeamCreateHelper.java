...
public class TeamCreateHelper {
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, TeamTypeEnum.Normal, "",
                ...
                new RequestCallback<Team>() {
                    ...
                    public void onSuccess(Team team) {
                        ...
                        Toast.makeText(MyCache.getContext(), com.netease.nim.uikit.R.string.create_team_success,
                    ...
                    public void onFailed(int code) {
                        ...
                        if (code == 801) {
                            ...
                            Toast.makeText(MyCache.getContext(), tip,
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(MyCache.getContext(), com.netease.nim.uikit.R.string.create_team_failed,
                                    Toast.LENGTH_SHORT).show();
                        }
    ...
    private static void onCreateSuccess(final Context context, final Team team) {
        ...
        DialogMaker.dismissProgressDialog();
        Toast.makeText(MyCache.getContext(), com.netease.nim.uikit.R.string.create_team_success, Toast.LENGTH_SHORT).show();
