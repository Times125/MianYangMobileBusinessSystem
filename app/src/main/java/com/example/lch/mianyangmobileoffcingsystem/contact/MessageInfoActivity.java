...
public class MessageInfoActivity extends UI implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        titleBarLayout = (LinearLayout) findViewById(R.id.message_info);
        ...
        titleText.setText(R.string.message_info);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_NORMAL) {
                ...
                if (selected != null && !selected.isEmpty()) {
                    ...
                    Toast.makeText(MyCache.getContext(), "请选择至少一个联系人！", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
