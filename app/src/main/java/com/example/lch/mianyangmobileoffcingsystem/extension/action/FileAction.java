package com.example.lch.mianyangmobileoffcingsystem.extension.action;

import android.content.Intent;
import android.util.Log;

import com.example.lch.mianyangmobileoffcingsystem.R;
import com.example.lch.mianyangmobileoffcingsystem.tools.FileBrowserActivity;
...
public class FileAction extends BaseAction {
    ...
    private void chooseFile() {
        ...
        Log.e("chooseFile: ", "FileBrowserActivity start");
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RequestCode.GET_LOCAL_FILE) {
            ...
            Log.e(TAG, "onActivityResult: " + message + "/" + message.getAttachment() );
            sendMessage(message);
        }
    }
}
