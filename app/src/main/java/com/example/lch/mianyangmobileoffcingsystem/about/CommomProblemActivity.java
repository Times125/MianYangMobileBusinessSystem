...
public class CommomProblemActivity extends UI implements View.OnClickListener {
    //title bar
    ...
    private void initViews() {
        ...
        titleBarLayout = (LinearLayout) findViewById(R.id.problem);
        ...
        webView.loadUrl("http://120.27.118.159/pin_board.html");
