...
import com.example.lch.mianyangmobileoffcingsystem.config.NimLocationManager;
...
public class TLocationProvider implements com.netease.nim.uikit.LocationProvider {
    @Override
