...
public class AnnouncementHelper {
    ...
    //有头像,但是头像网络地址不在json里面
    public static List<Announcement> getAnnouncementsWithUrl(String teamId, String announce,String url, int limit) {
        if (TextUtils.isEmpty(announce)) {
            return null;
        }
        ...
        try {
            ...
            for (int i = jsonArray.size() - 1; i >= 0; i--) {
                ...
                announcements.add(new Announcement(id, teamId, creator, title, time, content,url));
